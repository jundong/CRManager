...
qq.FileUploaderBasic.prototype = {
    ...
    _onComplete: function(id, fileName, result){
        ...
        if (result.result==="FAILURE" || result.is_error === true){
            var errorReason = result.messages[0].content ? result.messages[0].content : "Upload failure reason unknown";
...
qq.FileUploader = function(o){
    ...
    qq.extend(this._options, {
        ...
        fileTemplate: '<li>' +
            ...
            'Name: <span class="qq-upload-file"></span><br>' +
            'Size: <span class="qq-upload-size"></span><br>' +
        ...
        classes: {
            ...
            success: 'qq-upload-success validated',
            fail: 'qq-upload-fail error',
...
qq.extend(qq.FileUploader.prototype, {
    ...
    _onComplete: function(id, fileName, result){
        ...
        if (result.result==="SUCCESS" || result.ok==="ok" || result.is_error === false){
    ...
    _controlFailureTextDisplay: function(item, response) {
        var mode, maxChars, isErrorProperty, responseProperty, failureReason, shortFailureReason;

        mode = this._options.failedUploadTextDisplay.mode;
        maxChars = this._options.failedUploadTextDisplay.maxChars;
        responseProperty = this._options.failedUploadTextDisplay.responseProperty;
        isErrorProperty = this._options.failedUploadTextDisplay.isErrorProperty;

        if (mode === 'custom') {

            var failureReason = response[responseProperty];
            var isErrorPropertyCheck = response.isErrorProperty;
            if (isErrorPropertyCheck) {
